<?php
	...
	if (isset($_POST['update_course_listing'])) {
		...
		// echo ($user->update($data,$whereId)) ? json_encode(array("success" => true)) : json_encode(array("success" => false));
		echo $course->update() ? json_encode(array("success" => true)) : json_encode(array("success" => false));
